...
# 
#  Related Topics Array Hash Table Stack Monotonic Stack 👍 8617 👎 894
...
class Solution:
    ...
    def nextGreaterElement(self, nums1: List[int], nums2: List[int]) -> List[int]:
        ...
        # Build the mapping for next greater element using a monotonic stack
        for num in nums2:
    ...
    #             if nums2[i] < nums2[j]:
    #                 dict2[nums2[i]] = nums2[j]
    #                 break
    #
    #     return [dict2[num] for num in nums1]
