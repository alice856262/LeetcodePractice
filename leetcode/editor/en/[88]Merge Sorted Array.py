...
# 
#  Related Topics Array Two Pointers Sorting 👍 15984 👎 2152


# leetcode submit region begin(Prohibit modification and deletion)
class Solution:
    ### 1. Two Pointer Approach from Back
    ...
    #     Do not return anything, modify nums1 in-place instead.
    #     """
    #     # Create a new array with the first m elements of nums1 and all elements of nums2
