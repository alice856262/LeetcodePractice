...
<strong>Explanation:</strong>&nbsp;Every subsequence of string a is also a subsequence of string b. Similarly, every subsequence of string b is also a subsequence of string a. So the answer would be <span><code>-1</code></span>.
</pre>
...
<div><div>Related Topics</div><div><li>String</li></div></div><br><div><li>👍 72</li><li>👎 226</li></div>